...
class LoginForm extends CFormModel
{
	...
	public function rules()
	{
		return array(
			...
			array('email', 'required', 'message'=>'Campo de email não pode ser vazio.'),
			//Campo de senha requerido
			array('senha', 'required', 'message'=>'Campo de senha não pode ser vazio' ),
			// rememberMe needs to be a boolean
			array('rememberMe', 'boolean'),
			// password needs to be authenticated
			array('senha', 'authenticate'),
			//Valdação de email
			array('email', 'email', 'message'=>'Endereço de email incorreto.'),
		);
	}
